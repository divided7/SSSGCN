...
class ST_GCN_DWBackbone_MLPs(nn.Module):
    # 替换regression head中的卷积层为深层MLPs
    def __init__(self, num_classes, in_channels, t_kernel_size, hop_size):
        super().__init__()
        # graph制作
...
class ST_GCN_DWBackbone_MLPs_only_reg(nn.Module):
    # 替换regression head中的卷积层为深层MLPs
    def __init__(self, in_channels, t_kernel_size, hop_size):
        super().__init__()
        # graph制作
...
class ST_GCN_DWBackbone_MLPs_split(nn.Module):
    # 替换regression head中的卷积层为深层MLPs
    def __init__(self, num_classes, in_channels, t_kernel_size, hop_size):
        super().__init__()
        # graph制作
...
class ST_GCN_DWBackbone_MLPs_split_plus(nn.Module):
    # 替换regression head中的卷积层为深层MLPs
    def __init__(self, num_classes, in_channels, t_kernel_size, hop_size):
        super().__init__()
        # graph制作
        ...
        # Prediction
        self.fc = nn.Linear(32 + num_classes, 64)
        self.bn1 = nn.BatchNorm1d(32 + num_classes)
        self.tanh = nn.Tanh()
...
class Siamese_ST_GCN_DWBackbone_MLPs_only_reg(nn.Module):
    # 替换regression head中的卷积层为深层MLPs
    def __init__(self, in_channels, t_kernel_size, hop_size):
        super().__init__()
        # graph制作
